 ...
 */
public class InfoFaqStageBoardNodeScriptCreateDesc : StageBoardNodeScriptCreateDesc
{
}
 ...
 */
public class InfoFaqStageBoardNodeScript : StageBoardNodeScript
{
    ...
    public new InfoFaqStageBoardNodeScriptCreateDesc createDesc{get; private set;} = null;
    ...
    protected override int _OnCreate()
    {
        ...
        {// MessageNode Create
		    ...
		    case Util.LANGUAGE_TYPE.JAPANESE: {
                txt_ary = FaqMessageUtil.JAPANESE_TEXT_ARRAY;

			    break;
		    }
		    default: {
                txt_ary = FaqMessageUtil.ENGLISH_TEXT_ARRAY;
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new InfoFaqStageBoardNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as InfoFaqStageBoardNodeScriptCreateDesc;
