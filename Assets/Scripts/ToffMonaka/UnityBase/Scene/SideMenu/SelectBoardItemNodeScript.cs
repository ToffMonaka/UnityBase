...
public class SelectBoardItemNodeScript : ToffMonaka.Tml.Scene.NodeScript
{
    ...
    public new SelectBoardItemNodeScriptCreateDesc createDesc{get; private set;} = null;

    private System.Action<SelectBoardItemNodeScript> _onClick = null;
    ...
    {
        return ((int)SceneUtil.SCRIPT_INDEX.SIDE_MENU_SELECT_BOARD_ITEM_NODE);
    }
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new SelectBoardItemNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as SelectBoardItemNodeScriptCreateDesc;
