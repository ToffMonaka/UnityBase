 ...
 */
public class OptionSelect2BoardNodeScriptCreateDesc : Select2BoardNodeScriptCreateDesc
{
}
 ...
 */
public class OptionSelect2BoardNodeScript : Select2BoardNodeScript
{
    [SerializeField] private TMP_Text _backButtonNameText = null;

    public new OptionSelect2BoardNodeScriptCreateDesc createDesc{get; private set;} = null;
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new OptionSelect2BoardNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as OptionSelect2BoardNodeScriptCreateDesc;
