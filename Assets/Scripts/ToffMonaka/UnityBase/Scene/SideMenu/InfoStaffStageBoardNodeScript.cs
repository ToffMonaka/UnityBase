 ...
 */
public class InfoStaffStageBoardNodeScriptCreateDesc : StageBoardNodeScriptCreateDesc
{
}
 ...
 */
public class InfoStaffStageBoardNodeScript : StageBoardNodeScript
{
    ...
    public new InfoStaffStageBoardNodeScriptCreateDesc createDesc{get; private set;} = null;
    ...
    {
        return ((int)SceneUtil.SCRIPT_INDEX.SIDE_MENU_INFO_STAFF_STAGE_BOARD_NODE);
    }
    ...
    {
        return (SceneUtil.SIDE_MENU_BOARD_TYPE.INFO_STAFF_STAGE);
    }
    ...
    {
        return (SceneUtil.SIDE_MENU_STAGE_BOARD_TYPE.INFO_STAFF);
    }
    ...
    protected override int _OnCreate()
    {
        ...
        this._nameText.SetText(DataUtil.GetText(DataUtil.MST_TEXT_ID.INFO) + " > " + DataUtil.GetText(DataUtil.MST_TEXT_ID.STAFF));
        ...
        {// MessageNode Create
		    ...
		    case Util.LANGUAGE_TYPE.JAPANESE: {
                txt_ary = StaffMessageUtil.JAPANESE_TEXT_ARRAY;

			    break;
		    }
		    default: {
                txt_ary = StaffMessageUtil.ENGLISH_TEXT_ARRAY;
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new InfoStaffStageBoardNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as InfoStaffStageBoardNodeScriptCreateDesc;
