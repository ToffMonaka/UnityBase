...
public class CheatStageBoardItemNodeScript : ToffMonaka.Tml.Scene.ObjectNodeScript
{
    ...
    public new CheatStageBoardItemNodeScriptCreateDesc createDesc{get; private set;} = null;

    private CheatCommandUtil.ADD_CODE_TYPE _addCodeType = CheatCommandUtil.ADD_CODE_TYPE.NONE;
    private System.Action<CheatStageBoardItemNodeScript> _onClick = null;
    ...
    protected override int _OnCreate()
    {
        ...
        this._nameText.SetText(CheatCommandUtil.ADD_CODE_NAME_ARRAY[(int)this._addCodeType]);
        this._detailText.SetText(CheatCommandUtil.ADD_CODE_TEXT_ARRAY[(int)this._addCodeType]);
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new CheatStageBoardItemNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as CheatStageBoardItemNodeScriptCreateDesc;
     ...
     */
    public CheatCommandUtil.ADD_CODE_TYPE GetAddCodeType()
    {
