 ...
 */
public class InfoPrivacyPolicyStageBoardNodeScriptCreateDesc : StageBoardNodeScriptCreateDesc
{
}
 ...
 */
public class InfoPrivacyPolicyStageBoardNodeScript : StageBoardNodeScript
{
    ...
    public new InfoPrivacyPolicyStageBoardNodeScriptCreateDesc createDesc{get; private set;} = null;
    ...
    protected override int _OnCreate()
    {
        ...
        {// MessageNode Create
		    ...
		    case Util.LANGUAGE_TYPE.JAPANESE: {
                txt_ary = PrivacyPolicyMessageUtil.JAPANESE_TEXT_ARRAY;

			    break;
		    }
		    default: {
                txt_ary = PrivacyPolicyMessageUtil.ENGLISH_TEXT_ARRAY;
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new InfoPrivacyPolicyStageBoardNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as InfoPrivacyPolicyStageBoardNodeScriptCreateDesc;
