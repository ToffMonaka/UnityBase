...
public class OpenCloseButtonNodeScript : ToffMonaka.Tml.Scene.ObjectNodeScript
{
    ...
    private System.Action<OpenCloseButtonNodeScript> _onClick = null;
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new OpenCloseButtonNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as OpenCloseButtonNodeScriptCreateDesc;
