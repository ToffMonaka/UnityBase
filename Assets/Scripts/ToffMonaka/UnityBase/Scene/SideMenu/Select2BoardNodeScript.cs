 ...
 */
public class Select2BoardNodeScriptCreateDesc : BoardNodeScriptCreateDesc
{
    public System.Action<Select2BoardNodeScript, SceneUtil.SIDE_MENU_STAGE_BOARD_TYPE> onOpenStageBoard = null;
    public System.Action<Select2BoardNodeScript> onCloseSelect2Board = null;
}
...
public abstract class Select2BoardNodeScript : BoardNodeScript
{
    ...
    protected List<SelectBoardItemNodeScript> _itemNodeScriptContainer = new();
    protected System.Action<Select2BoardNodeScript, SceneUtil.SIDE_MENU_STAGE_BOARD_TYPE> _onOpenStageBoard = null;
    protected System.Action<Select2BoardNodeScript> _onCloseSelect2Board = null;
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new Select2BoardNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as Select2BoardNodeScriptCreateDesc;
