 ...
 */
public class InfoLicenseStageBoardNodeScriptCreateDesc : StageBoardNodeScriptCreateDesc
{
}
 ...
 */
public class InfoLicenseStageBoardNodeScript : StageBoardNodeScript
{
    ...
    public new InfoLicenseStageBoardNodeScriptCreateDesc createDesc{get; private set;} = null;
    ...
    {
        return ((int)SceneUtil.SCRIPT_INDEX.SIDE_MENU_INFO_LICENSE_STAGE_BOARD_NODE);
    }
    ...
    {
        return (SceneUtil.SIDE_MENU_BOARD_TYPE.INFO_LICENSE_STAGE);
    }
    ...
    {
        return (SceneUtil.SIDE_MENU_STAGE_BOARD_TYPE.INFO_LICENSE);
    }
    ...
    protected override int _OnCreate()
    {
        ...
        this._nameText.SetText(DataUtil.GetText(DataUtil.MST_TEXT_ID.INFO) + " > " + DataUtil.GetText(DataUtil.MST_TEXT_ID.LICENSE));
        ...
        {// MessageNode Create
            var txt_ary = LicenseMessageUtil.TEXT_ARRAY;
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new InfoLicenseStageBoardNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as InfoLicenseStageBoardNodeScriptCreateDesc;
