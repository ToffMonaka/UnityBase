...
public static class CheatCommandParserUtil
{
    ...
    public static readonly int NODE_TYPE_COUNT = (int)CheatCommandParserUtil.NODE_TYPE.COUNT;

    public static readonly CheatCommandParserOperator[] UNARY_OPERATOR_ARRAY = {
        new("+", 0),
        new("-", 0),
        new("~", 0)
    };
...
{
    private CheatCommandParserUtil.NODE_TYPE _nodeType;
    private string _text;
    private List<CheatCommandParserNode> _argumentNodeContainer;
    private CheatCommandParserOperator _operator_;
    private CheatCommandParserNode _leftNode;
    private CheatCommandParserNode _rightNode;
    ...
    {
        this._nodeType = CheatCommandParserUtil.NODE_TYPE.NONE;
        this._text = "";
     ...
     */
    public CheatCommandParserNode(CheatCommandParserUtil.NODE_TYPE node_type)
    {
     ...
     * @param txt (text)
     */
    public CheatCommandParserNode(CheatCommandParserUtil.NODE_TYPE node_type, string txt)
    {
        this._nodeType = node_type;
        this._text = txt;
        this._argumentNodeContainer = null;
     ...
     */
    public CheatCommandParserNode(CheatCommandParserUtil.NODE_TYPE node_type, string txt, List<CheatCommandParserNode> arg_node_cont)
    {
        this._nodeType = node_type;
        this._text = txt;
     ...
     */
    public CheatCommandParserNode(CheatCommandParserUtil.NODE_TYPE node_type, string txt, CheatCommandParserOperator op, CheatCommandParserNode left_node, CheatCommandParserNode right_node)
    {
        this._nodeType = node_type;
        this._text = txt;
        this._argumentNodeContainer = null;
     ...
     */
    public CheatCommandParserUtil.NODE_TYPE GetNodeType()
    {
     ...
     */
    public List<CheatCommandParserNode> GetArgumentNodeContainer()
    {
     ...
     * @return op (operator)
     */
    public CheatCommandParserOperator GetOperator()
    {
     ...
     */
    public CheatCommandParserNode GetLeftNode()
    {
     ...
     */
    public CheatCommandParserNode GetRightNode()
    {
...
public class CheatCommandParser
{
    ...
    private List<CheatCommandParserNode> _nodeContainer;
    ...
    public CheatCommandParser()
    {
        this._code = "";
        this._codeIndex = 0;
        this._nodeContainer = new List<CheatCommandParserNode>();
     ...
     */
    public List<CheatCommandParserNode> GetNodeContainer()
    {
    ...
    private void _Parse()
    {
        do {
            ...
            if (parse_result.Item2 != null) {
                ...
                this._nodeContainer.Add(new CheatCommandParserNode(CheatCommandParserUtil.NODE_TYPE.EMPTY));
            }
     ...
     */
    private System.Tuple<int, CheatCommandParserNode> _ParseNode()
    {
        var parse_result = this._ParseUnaryNode();

        if (parse_result.Item1 < 0) {
            return (new System.Tuple<int, CheatCommandParserNode>(-1, null));
        }
     ...
     * @return result (result)
     */
    private System.Tuple<int, CheatCommandParserNode> _ParseUnaryNode()
    {
        this._ParseTrim();
        ...
        if (this._IsNumber(c) || (c == '.')) {
            ...
            var node = new CheatCommandParserNode(CheatCommandParserUtil.NODE_TYPE.NUMBER, node_txt);

            return (new System.Tuple<int, CheatCommandParserNode>(0, node));
        } else {
            ...
            if (op_parse_result.Item2 != null) {
                ...
                var node = new CheatCommandParserNode(CheatCommandParserUtil.NODE_TYPE.UNARY_EXPRESSION, System.String.Empty, op_parse_result.Item2, null, right_parse_result.Item2);
            ...
            if (this._IsIdentifierStart(c)) {
                ...
                if (c == '(') {
                    var arg_node_cont = new List<CheatCommandParserNode>();
                    ...
                    var node = new CheatCommandParserNode(CheatCommandParserUtil.NODE_TYPE.FUNCTION, identifier, arg_node_cont);
        ...
        return (new System.Tuple<int, CheatCommandParserNode>(0, null));
    }
     ...
     * @return result (result)
     */
    private System.Tuple<int, CheatCommandParserOperator> _ParseUnaryOperator()
    {
        this._ParseTrim();

        var op_name = this._GetString(this._codeIndex, CheatCommandParserUtil.UNARY_OPERATOR_MAX_LENGTH);

        while (op_name.Length > 0) {
            foreach (var tmp_op in CheatCommandParserUtil.UNARY_OPERATOR_ARRAY) {
                if (tmp_op.GetName() == op_name) {
                    this._codeIndex += op_name.Length;

                    return (new System.Tuple<int, CheatCommandParserOperator>(0, tmp_op));
                }
            }
        ...
        return (new System.Tuple<int, CheatCommandParserOperator>(0, null));
    }
