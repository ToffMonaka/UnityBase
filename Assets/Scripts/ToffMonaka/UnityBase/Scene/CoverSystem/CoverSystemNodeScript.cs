/**
 * @file
 * @brief CoverSystemNodeScriptファイル
 */
...
public class CoverSystemNodeScript : ToffMonaka.Tml.Scene.ObjectNodeScript
{
    ...
    private List<CoverNodeScript> _coverNodeScriptContainer = new();
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new CoverSystemNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as CoverSystemNodeScriptCreateDesc;
     ...
     * null=失敗
     */
    public CoverNodeScript AddCover(CoverNodeScriptCreateDesc cover_node_script_create_desc)
    {
