...
namespace UnityBase.Scene.CoverSystem {
/**
 * @brief SimpleCoverNodeScriptCreateDescクラス
 */
public class SimpleCoverNodeScriptCreateDesc : CoverNodeScriptCreateDesc
{
     ...
     */
    public override CoverNodeScript GetNewScript(string prefab_file_path)
    {
        var node = ToffMonaka.Tml.Scene.SceneUtil.GetPrefabNode(prefab_file_path);

        return (node.GetComponent<SimpleCoverNodeScript>());
    }
}
 ...
 */
public class SimpleCoverNodeScript : CoverNodeScript
{
    [SerializeField] private Image _coverImage = null;

    public new SimpleCoverNodeScriptCreateDesc createDesc{get; private set;} = null;
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new SimpleCoverNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as SimpleCoverNodeScriptCreateDesc;
