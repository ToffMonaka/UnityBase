...
public class FieldNodeScript : ToffMonaka.Tml.Scene.ObjectNodeScript
{
    ...
    {
        return ((int)SceneUtil.SCRIPT_INDEX.TEST_2D_STAGE_FIELD_NODE);
    }
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new FieldNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as FieldNodeScriptCreateDesc;
