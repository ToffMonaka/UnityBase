...
public class CameraPadNodeScript : ToffMonaka.Tml.Scene.NodeScript
{
    ...
    private InputAction _cursorInputAction = null;
    ...
    protected override void _OnAwake()
    {
        ...
        this._cursorInputAction = InputSystem.actions.FindAction("UI/Cursor");
        this._cursorInputAction.Disable();
    ...
    {
        if (this._cursorInputAction.phase == InputActionPhase.Started) {
            this._cursorNode.SetActive(true);
            this._cursorNode.transform.position = new Vector3(this._cursorInputAction.ReadValue<Vector2>().x, this._cursorInputAction.ReadValue<Vector2>().y, 0.0f);
        } else {
            this._cursorNode.SetActive(false);
        }
    ...
    public void OnPointerDown(PointerEventData event_dat)
    {
        ...
        this._cursorInputAction.Enable();
