...
public class BackButtonNodeScript : ToffMonaka.Tml.Scene.NodeScript
{
    ...
    private System.Action<BackButtonNodeScript> _onClick = null;
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new BackButtonNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as BackButtonNodeScriptCreateDesc;
