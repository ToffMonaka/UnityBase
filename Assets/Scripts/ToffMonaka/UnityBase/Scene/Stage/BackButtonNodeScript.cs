...
{
    public System.Action<UnityBase.Scene.Stage.BackButtonNodeScript> onClick = null;
}
...
public class BackButtonNodeScript : Lib.Scene.ObjectNodeScript
{
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new UnityBase.Scene.Stage.BackButtonNodeScriptCreateDesc());
