...
{
    public UnityBase.Scene.Stage.Test2D.SubSceneScript subSceneScript = null;
}
...
public class BackButtonScript : Lib.Scene.ObjectScript, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public new UnityBase.Scene.Stage.Test2D.BackButtonScriptCreateDesc createDesc{get; private set;} = null;

    private UnityBase.Scene.Stage.Test2D.SubSceneScript _subSceneScript = null;
    ...
    {
        this._SetScriptIndex((int)UnityBase.Constant.Util.SCENE.SCRIPT_INDEX.TEST_2D_STAGE_BACK_BUTTON);
    ...
    {
	    this.createDesc = create_desc as UnityBase.Scene.Stage.Test2D.BackButtonScriptCreateDesc;
