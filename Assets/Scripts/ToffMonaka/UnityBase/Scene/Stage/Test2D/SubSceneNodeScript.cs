...
public class SubSceneNodeScript : UnityBase.Scene.Stage.SubSceneNodeScript
{
    ...
    protected override int _OnCreate()
    {
        ...
        this._nameText.SetText(DataUtil.GetText(UnityBase.Util.MST_TEXT_ID.TEST_2D));
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new UnityBase.Scene.Stage.Test2D.SubSceneNodeScriptCreateDesc());
