 ...
 */
public class InfoSelect2BoardNodeScriptCreateDesc : UnityBase.Scene.Ui.Menu.Side.Select2BoardNodeScriptCreateDesc
{
}
 ...
 */
public class InfoSelect2BoardNodeScript : UnityBase.Scene.Ui.Menu.Side.Select2BoardNodeScript
{
    [SerializeField] private TMP_Text _backButtonNameText = null;

    public new UnityBase.Scene.Ui.Menu.Side.InfoSelect2BoardNodeScriptCreateDesc createDesc{get; private set;} = null;
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new UnityBase.Scene.Ui.Menu.Side.InfoSelect2BoardNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as UnityBase.Scene.Ui.Menu.Side.InfoSelect2BoardNodeScriptCreateDesc;
