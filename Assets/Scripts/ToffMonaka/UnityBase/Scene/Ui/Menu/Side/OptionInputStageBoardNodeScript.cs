/**
 * @file
 * @brief OptionInputStageBoardNodeScriptファイル
 */
...
/**
 * @brief OptionInputStageBoardNodeScriptCreateDescクラス
 */
public class OptionInputStageBoardNodeScriptCreateDesc : UnityBase.Scene.Ui.Menu.Side.StageBoardNodeScriptCreateDesc
{
}

/**
 * @brief OptionInputStageBoardNodeScriptクラス
 */
public class OptionInputStageBoardNodeScript : UnityBase.Scene.Ui.Menu.Side.StageBoardNodeScript
{
    [SerializeField] private ScrollRect _scrollRect = null;
    [SerializeField] private TMP_Text _okButtonNameText = null;
    [SerializeField] private TMP_Text _cancelButtonNameText = null;

    public new UnityBase.Scene.Ui.Menu.Side.OptionInputStageBoardNodeScriptCreateDesc createDesc{get; private set;} = null;
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new UnityBase.Scene.Ui.Menu.Side.OptionInputStageBoardNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as UnityBase.Scene.Ui.Menu.Side.OptionInputStageBoardNodeScriptCreateDesc;
