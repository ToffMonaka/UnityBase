/**
 * @file
 * @brief InfoFaqStageBoardNodeScriptファイル
 */
...
/**
 * @brief InfoFaqStageBoardNodeScriptCreateDescクラス
 */
public class InfoFaqStageBoardNodeScriptCreateDesc : UnityBase.Scene.Ui.Menu.Side.StageBoardNodeScriptCreateDesc
{
}

/**
 * @brief InfoFaqStageBoardNodeScriptクラス
 */
public class InfoFaqStageBoardNodeScript : UnityBase.Scene.Ui.Menu.Side.StageBoardNodeScript
{
    ...
    public new UnityBase.Scene.Ui.Menu.Side.InfoFaqStageBoardNodeScriptCreateDesc createDesc{get; private set;} = null;
    ...
    protected override int _OnCreate()
    {
        ...
        {// MessageNode Create
		    ...
		    default: {
                txt_ary = UnityBase.Scene.Ui.Menu.Side.FaqMessageUtil.ENGLISH_TEXT_ARRAY;
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new UnityBase.Scene.Ui.Menu.Side.InfoFaqStageBoardNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as UnityBase.Scene.Ui.Menu.Side.InfoFaqStageBoardNodeScriptCreateDesc;
