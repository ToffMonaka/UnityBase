/**
 * @file
 * @brief DialogSystemNodeScriptファイル
 */
...
public class DialogSystemNodeScript : ToffMonaka.Tml.Scene.ObjectNodeScript
{
    ...
    private List<DialogNodeScript> _dialogNodeScriptContainer = new();
    ...
    {
        return ((int)SceneUtil.SCRIPT_INDEX.DIALOG_SYSTEM_NODE);
    }
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new DialogSystemNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as DialogSystemNodeScriptCreateDesc;
     ...
     * null=失敗
     */
    public DialogNodeScript AddDialog(DialogNodeScriptCreateDesc dialog_node_script_create_desc)
    {
