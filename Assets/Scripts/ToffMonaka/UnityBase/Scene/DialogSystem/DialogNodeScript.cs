...
public class DialogNodeScriptCreateDesc : ToffMonaka.Tml.Scene.ObjectNodeScriptCreateDesc
{
     ...
     */
    public virtual DialogNodeScript GetNewScript(string prefab_file_path)
    {
        return (null);
    }
}
...
public abstract class DialogNodeScript : ToffMonaka.Tml.Scene.ObjectNodeScript
{
    ...
    public new DialogNodeScriptCreateDesc createDesc{get; private set;} = null;
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new DialogNodeScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as DialogNodeScriptCreateDesc;
