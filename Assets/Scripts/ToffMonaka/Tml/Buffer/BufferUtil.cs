...
public static class BufferUtil
{
    ...
    {
        float val = 0.0f;
        int tmp_val = BufferUtil.ReadIntB(buf, buf_size, ref buf_index, ref dst_result_val);
    ...
    {
        float val = 0.0f;
        int tmp_val = BufferUtil.ReadIntL(buf, buf_size, ref buf_index, ref dst_result_val);
    ...
    {
        double val = 0.0;
        long tmp_val = BufferUtil.ReadLongB(buf, buf_size, ref buf_index, ref dst_result_val);
    ...
    {
        double val = 0.0;
        long tmp_val = BufferUtil.ReadLongL(buf, buf_size, ref buf_index, ref dst_result_val);
    ...
    public static string ReadStringB(string charset, byte[] buf, int buf_size, ref int buf_index, ref int dst_result_val)
    {
    	...
    	int str_size = BufferUtil.ReadShortB(buf, buf_size, ref buf_index, ref dst_result_val);
    ...
    public static string ReadStringL(string charset, byte[] buf, int buf_size, ref int buf_index, ref int dst_result_val)
    {
    	...
    	int str_size = BufferUtil.ReadShortL(buf, buf_size, ref buf_index, ref dst_result_val);
    ...
    public static void WriteFloatB(float val, byte[] buf, int buf_size, ref int buf_index, ref int dst_result_val)
    {
    	...
    	BufferUtil.WriteIntB(tmp_val, buf, buf_size, ref buf_index, ref dst_result_val);
    ...
    public static void WriteFloatL(float val, byte[] buf, int buf_size, ref int buf_index, ref int dst_result_val)
    {
    	...
    	BufferUtil.WriteIntL(tmp_val, buf, buf_size, ref buf_index, ref dst_result_val);
    ...
    public static void WriteDoubleB(double val, byte[] buf, int buf_size, ref int buf_index, ref int dst_result_val)
    {
    	...
    	BufferUtil.WriteLongB(tmp_val, buf, buf_size, ref buf_index, ref dst_result_val);
    ...
    public static void WriteDoubleL(double val, byte[] buf, int buf_size, ref int buf_index, ref int dst_result_val)
    {
    	...
    	BufferUtil.WriteLongL(tmp_val, buf, buf_size, ref buf_index, ref dst_result_val);
    ...
    public static void WriteStringB(byte[] str_buf, byte[] buf, int buf_size, ref int buf_index, ref int dst_result_val)
    {
    	...
    	BufferUtil.WriteShortB((short)str_buf.Length, buf, buf_size, ref buf_index, ref dst_result_val);
    	BufferUtil.WriteArray(str_buf, str_buf.Length, buf, buf_size, ref buf_index, ref dst_result_val);
    ...
    public static void WriteStringL(byte[] str_buf, byte[] buf, int buf_size, ref int buf_index, ref int dst_result_val)
    {
    	...
    	BufferUtil.WriteIntL(str_buf.Length, buf, buf_size, ref buf_index, ref dst_result_val);
    	BufferUtil.WriteArray(str_buf, str_buf.Length, buf, buf_size, ref buf_index, ref dst_result_val);
