 ...
 */
public class ScrollViewPartsScript : PartsScript
{
    ...
    public new ScrollViewPartsScriptCreateDesc createDesc{get; private set;} = null;
    ...
    {
        if (create_desc == null) {
            this.SetCreateDesc(new ScrollViewPartsScriptCreateDesc());

            return;
        }

	    this.createDesc = create_desc as ScrollViewPartsScriptCreateDesc;
