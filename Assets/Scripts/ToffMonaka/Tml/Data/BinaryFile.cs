 ...
 */
public class BinaryFileWriteDescData : FileWriteDescData
{
    /**
     * @brief コンストラクタ
     */
...
{
	public BinaryFileData data = new();
	public FileReadDesc<BinaryFileReadDescData> readDesc = new();
	public FileWriteDesc<BinaryFileWriteDescData> writeDesc = new();
